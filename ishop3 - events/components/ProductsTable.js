...
class ProductsTable extends React.Component {
  ...
  componentDidMount = () => {
    prodEvents.addListener('EMarked',this.productMarked);
    prodEvents.addListener('EDeleteRow',this.deleteRow);
    prodEvents.addListener('EEditProduct',this.editProduct);
    prodEvents.addListener('ECancel',this.cancel);
    prodEvents.addListener('EProductNotSave',this.productNotSave);
    prodEvents.addListener('ESave',this.save);
    prodEvents.addListener('EAdd',this.add);
  };

  componentWillUnmount = () => {
    prodEvents.removeListener('EMarked',this.productMarked);
    prodEvents.removeListener('EDeleteRow',this.deleteRow);
    prodEvents.removeListener('EEditProduct',this.editProduct);
    prodEvents.removeListener('ECancel',this.cancel);
    prodEvents.removeListener('EProductNotSave',this.productNotSave);
    prodEvents.removeListener('ESave',this.save);
    prodEvents.removeListener('EAdd',this.add);
  };
